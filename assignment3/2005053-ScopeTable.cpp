            ...
            if (arr[i] != nullptr)
            {
                ...
                while (temp != nullptr)
                {
                    ...
                    if (temp->checkFunctionGetter())
                    {
                        if (flag)
                        {
                            fprintf(logout, " <%s,FUNCTION,%s>", temp->nameGetter().c_str(), temp->retTypeGetter().c_str());
                        }
                        else
                        {
                            fprintf(logout, " --> <%s,FUNCTION,%s>", temp->nameGetter().c_str(), temp->retTypeGetter().c_str());
                    ...
                    else if (temp->checkArrayGetter())
                    {
                        if (flag)
                        {
                            fprintf(logout, " <%s,ARRAY>", temp->nameGetter().c_str());
                        }
                        else
                        {
                            fprintf(logout, " --> <%s,ARRAY>", temp->nameGetter().c_str());
                    ...
                    else if (temp->typeGetter().compare("ID") == 0)
                    {
                        if (flag)
                        {
                            fprintf(logout, " <%s,%s>", temp->nameGetter().c_str(), temp->varTypeGetter().c_str());
                        }
                        else
                        {
                            fprintf(logout, " --> <%s,%s>", temp->nameGetter().c_str(), temp->varTypeGetter().c_str());
